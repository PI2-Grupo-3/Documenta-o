...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth, keepaspectratio]{figuras/software/NFR/NFR_segurança.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=7cm]{figuras/software/Atual_prototipo/Enfermeiro_gerenciarEstoqueMaquina_1.png}
     \label{fig:prototipo_enfermeiro_gerenciarEstoqueMaquina_1}}
    \subfloat[][Fluxo para deletar uma medicação do estoque da máquina]{
    \includegraphics[width=7cm]{figuras/software/Atual_prototipo/Enfermeiro_gerenciarEstoqueMaquina_2.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=6cm]{figuras/software/Atual_prototipo/Enfermeiro_abastecer_1.png}
    ...
    \includegraphics[width=6cm]{figuras/software/Atual_prototipo/Enfermeiro_abastecer_1-1.png}
...
A Fig. \ref{fig:prototipo_paciente_estoqueDeMedicacao} apresenta o fluxo para visualizar o estoque de medicação, ilustrando todas as medicações e seus respectivos dados como horários de ministração, dias de uso, quantidade e nível do estoque.
...
E o \textit{Mosquitto} nada mais é do que um dos componentes do protocolo MQTT. Cada vez mais usado no setor industrial, ele aparece como uma forma de otimizar o tempo e tornar os processos mais simples \cite{ENGPROCESS_2018}.
